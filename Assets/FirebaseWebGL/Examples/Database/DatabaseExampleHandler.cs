...
namespace FirebaseWebGL.Examples.Database
{
    public class DatabaseExampleHandler : MonoBehaviour
    {
        ...
        public void GetJSON(string path ) =>
            FirebaseDatabase.GetJSON(path, gameObject.name, "DisplayData", "DisplayErrorObject");

        public void CheckJSON(string path) =>
         FirebaseDatabase.CheckJSON(path, gameObject.name, "CheckData", "DisplayErrorObject");

        public void PostJSON(string path, string value) => FirebaseDatabase.PostJSON(path, value, gameObject.name,
