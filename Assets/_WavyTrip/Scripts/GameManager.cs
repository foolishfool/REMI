...
public class GameManager : MonoBehaviour
{
    ...
    IEnumerator CRRestartGame(float delay = 0)
    {
        ...
        SceneManager.UnloadSceneAsync("WavyTrip");
    ...
    {
        SceneManager.UnloadSceneAsync("WavyTrip");
        GameController.Instance.GetBackHallway();
    ...
    {
        if (listPath[pathIndex].transform.position.x < gamecamera.transform.position.x - 20f)
        {
